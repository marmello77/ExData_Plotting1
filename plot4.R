...
#Make Plot 4 by combining in a panel plots 2 and 3, plus two new plots,
#and then export the panel as a PNG image
...
with(energy3, plot(DateTime, Voltage,
                   type = "l",
                   xlab = "datetime"))


with(energy3, plot(DateTime, Global_reactive_power,
                   type = "l",
                   xlab = "datetime"))
